...
namespace FiiiChain.Consensus
{
    public class BlockSetting
    {
        ...
        public const string GenesisBlockReceiver_Main = "fiiimTVMxZATSTQEXux7jy79HRK22a3gbRbW8A";

        public const string GenesisBlockReceiver_Testnet = "fiiitC5orKjASNNVKihKGEFXvtWjfXBVUnXALW";

        public const string GenesisBlockRemark_Main = "A new energy efficient cryptocurrency with the balance of decentralization, security and performance designed by Fiii - Financial Intelligence, Innovation & Integrity";
